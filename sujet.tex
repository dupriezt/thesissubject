...
When the program execution reaches a breakpoint, the execution is suspended and the debugger shows the developer the current state of the execution.
...
\subsection{Mon expérience préalable}
