...
% This tool is a prototype built with the goal of allowing the developer to access the past state of an execution.
...
% \gp{Tell it as if it was an experiment. What did you learn from it?}
As an attempt to help the developer finding the source of a bug, we developed this prototype, based on the idea expressed by Arya \emph{et al.}~\cite{Arya17a}.
