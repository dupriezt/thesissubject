...
% Référence vers le Bouquin de Zeller
...
Several works have been proposed to help developers with this task.
...
\emph{Master Slave Mode.}
???

\emph{Execution Comparison.}
% What would be a language to script the parallel progression of two executions?

\emph{Invariant Checker}


\emph{Back in time debugger.}
